...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      details: "carlos@metalpro.com.ar",
      action: "mailto:carlos@metalpro.com.ar"
    },
    {
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 h-64 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 mb-2">San Juan, Argentina</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <a
                    href="mailto:carlos@metalurgicacael.com.ar?subject=Consulta%20sobre%20servicios%20metalúrgicos"
